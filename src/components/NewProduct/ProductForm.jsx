  ...
  return (
    <form onSubmit={submitHandler} className='product-form'>
        <div className='product-form-input'>
            ...
            <input onChange={(e)=> setProductTitle(e.target.value)} type="text" placeholder='Ürün adı giriniz..'/>
        </div>
        <div className='product-form-input'>
            <label>Ürün Fiyatı</label>
            <input onChange={(e)=> setProductPrice(e.target.value)} type="number" placeholder='Ürün fiyatı giriniz..'/>
        </div>
        <div className='product-form-input'>
            <label>Ürün Görseli</label>
            <input onChange={(e)=> setImageUrl(e.target.value)} type="text" placeholder='Ürün görseli giriniz..'/>
        </div>
